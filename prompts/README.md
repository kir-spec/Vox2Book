# Prompts — три языка / three languages / три мови

Выберите папку своего языка — **внутри неё полный набор промптов**.

| Язык | Папка | Старт для чата |
|------|-------|----------------|
| 🇷🇺 Русский | [`ru/`](ru/) | [`ru/START_USER_PROMPT.md`](ru/START_USER_PROMPT.md) |
| 🇬🇧 English | [`en/`](en/) | [`en/START_USER_PROMPT.md`](en/START_USER_PROMPT.md) |
| 🇺🇦 Українська | [`uk/`](uk/) | [`uk/START_USER_PROMPT.md`](uk/START_USER_PROMPT.md) |
