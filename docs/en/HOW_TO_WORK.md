...
2. Put source in `inputs/raw_texts/`.
3. Copy prompt from [`prompts/en/START_USER_PROMPT.md`](../prompts/en/START_USER_PROMPT.md).
4. Answer AI questions (or say “proceed”).
...
Other languages: [RU](ru/HOW_TO_WORK.md) · [UK](uk/HOW_TO_WORK.md)
