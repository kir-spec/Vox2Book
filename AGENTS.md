...
- **Помесячные диалоги:** Каноническая структура `финальная_обработка_текстов/ГГГГ/ГГГГ-ММ_НазваниеМесяца.txt` (ровно 1 сводный файл на месяц со 100% хронологической сортировкой `YYYY-MM-DD HH:MM:SS Спикер (голосовое|текст)`).
- **Гигиена ссылок и веб-мусора:** Автоматическое удаление всех веб-ссылок (`https://...`), плашек ботов (`@TopSaversBot`, `720p`, `1080p`) и служебного мусора.
  - *Реплики только из ссылки, смайлика или заглушки `[Транскрипция недоступна]` удалять целиком вместе с заголовком спикера.*
  - *Реплики с текстовым комментарием автора сохранять, удаляя только саму URL-ссылку.*
- **Очистка галлюцинаций Whisper:** Удаление служебных комментариев (`# backend: faster-whisper...`) и титровых галлюцинаций (*«Редактор субтитров...»*, *«ТРЕВОЖНАЯ МУЗЫКА...»*, *«Продолжение следует...»* на тишине), сохраняя реальную речь о технологиях.
- **Контекстный аудит (±10 реплик):** Обязательная проверка контекста ±10 сообщений до и после фрагмента перед признанием мусором или удалением.
- **Глубокий контекстно-семантический и морфологический аудит STT:** Обязательная проверка 6 уровней академического филологического классификатора (§13 `UNIVERSAL_EDITORIAL_SPEC.ru.md`): восстановление флексий и согласовательных падежных окончаний (*на территорию других*, *с одной стороны*), омонимическая дизамбигуация (*насчёт* vs *на счёт*, *иметь в виду*, *полгода*, *на контрасте*), ликвидация парцелляции и запяточных склеек (comma splices).
- **Нецензурная лексика:** Категорическое соблюдение `keep_mat=True` — сохранение 100% мата и живого устного колорита.
- 8 обязательных аудитов + `check_cuts` + 6 уровней академического филологического аудита (§13)
