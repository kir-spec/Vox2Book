#!/usr/bin/env python3
"""
Fixes 'надо делку ушло' -> 'на доделку ушло' in:
...
for p in doc.paragraphs:
    ...
    if m:
        ...
        body = re.sub(r'\bнадо делку ушло\b', 'на доделку ушло', body, flags=re.IGNORECASE)
        body = re.sub(r'\bна делку ушло\b', 'на доделку ушло', body, flags=re.IGNORECASE)
...
print("Done fixing 'надо делку ушло' -> 'на доделку ушло'.")
